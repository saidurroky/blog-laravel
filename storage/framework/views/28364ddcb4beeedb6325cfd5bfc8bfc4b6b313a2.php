...
<div id="templatemo_content">
    ...
    <div class="service_box">
        ...
        <div class="left">
            <img src="<?php echo e(asset('images/chart1.png')); ?>" alt="image" />
        </div>
        <div class="right">
    ...
    <div class="service_box">
        ...
        <div class="left">
            <img src="<?php echo e(asset('images/chart2.png')); ?>" alt="image" />
        </div>
        <div class="right">
