                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="{{URL::to('/add_category')}}"><i class="icon-edit"></i><span class="hidden-tablet"> Add Category</span></a></li>
                            <li><a href="{{URL::to('/manage_category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Category</span></a></li>
                            <li><a href="{{URL::to('/add_blog')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Blog</span></a></li>
                            <li><a href="{{URL::to('/manage_blog')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Manage Blog</span></a></li>
                            <li>
